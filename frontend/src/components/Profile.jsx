  ...
  return (
    <div className="bg-gradient-to-b from-zinc-50 to-zinc-100 min-h-screen">
      ...
      <div className="topbar flex justify-between">
        <img
          src="../images/mev2.jpeg"
          className="rounded-full w-32 h-32 shadow-sm border-4 -mt-12 ml-7"
        />
      ...
      <div class="flex mx-4 flex-col">
        ...
        <h3 class="text-gray-800 font-semibold text-x1 mt-5">
          Personal Goals:
        </h3>
        <p className="mx-auto my-auto">{profile.goal[0]}</p>
        <p className="mx-auto my-auto">{profile.goal[1]}</p>
        <p className="mx-auto my-auto">{profile.goal[2]}</p>
      </div>
    </div>
  );
};
